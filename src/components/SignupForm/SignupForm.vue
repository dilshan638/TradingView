...
import SignupFormEmail from './SignupFormEmail.vue'
import SignupFormMobile from './SignupFormMobile.vue'

export default {
  components: { SignupFormEmail, SignupFormMobile },
    name:'SignupForm',
    setup() {
