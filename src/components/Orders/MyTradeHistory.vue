  ...
  methods: {
   ...
   async oneWeekFilter() {
     ...
     const headers = {
      ...
      axios
        .get(
          `https://tradeapi.exus.live/api/orders?productId=&before&after&startDate=${this.oneWeek}&endtDate=${this.todayDate}&limit=1000&side=&status=filled`,
          {
            headers: headers,
          }
        )
    ...
    async oneMonthFilter() {
     ...
     const headers = {
      ...
      axios
        .get(
          `https://tradeapi.exus.live/api/orders?productId=&status=filled&before&after&startDate=${this.oneMonth}&endtDate=${this.todayDate}&limit=1000&side=`,
          {
            headers: headers,
          }
        )
     ...
     const headers = {
      ...
      axios
        .get(
          `https://tradeapi.exus.live/api/orders?productId=&status=filled&before&after&startDate=${this.threeMonth}&endtDate=${this.todayDate}&limit=1000&side=`,
          {
            headers: headers,
          }
        )
    ...
    async getData() {
      ...
      axios
        .get(
          "https://tradeapi.exus.live/api/orders?productId=BTC/USDC&status=filled&before&after&limit=100",
          {
            headers: headers,
          }
        )
