<template>
  <div class="form-layout">
      ...
      <div class="col-md-6 no-padding">
        <div class="right-form">
          ...
          <div class="eye-area mb-4">
            ...
            <span class="error-msg" v-if="v$.password.password.$error"
          ...
          <span
            class="forgot-link"
            @click="$refs.forgotpasswordmodal.openModal()"
        ...
        <div class="tab-content modal-tab">
          ...
          >
            ...
            <div class="form-group pos-rel">
              ...
              />
              <span class="error-msg" v-if="v$.forgotpasswordemail.$error"
                >{{ v$.forgotpasswordemail.$errors[0].$message }}
              </span>
            </div>
            ...
            <div class="modal-buttons">
              ...
              <button
                ...
                @click="$refs.forgotpasswordmodal.closeModal()"
              >
                Cancel
              </button>
            </div>
    ...
    <modal ref="otpcodemodal">
      ...
      <template v-slot:body>
        <p>
          ...
          your registered email on LDCX
        </p>

        <b>ab*@*.com</b>
        <span class="resend-area"
          >Didn't Received <a href="#" @click="resend">Resend Code</a></span
        >
        ...
        <div class="form-group pos-rel mb-4">
          ...
          />
          <span class="error-msg" v-if="v$.verificationCode.$error"
        ...
        <div class="form-group mb-4">
          <div class="eye-area">
            <input
              v-bind:type="[showPasswordotp ? 'text' : 'password']"
              class="form-control"
              placeholder="Password"
            ...
            <div class="eye-box">
              <i
                @click="showPasswordotp = !showPasswordotp"
                :class="[showPasswordotp ? 'ri-eye-off-line' : 'ri-eye-line']"
                aria-hidden="true"
              ></i>
            </div>
        ...
        <div class="form-group">
          <div class="eye-area">
            <input
              v-bind:type="[showPasswordotpconfirm ? 'text' : 'password']"
              class="form-control"
            ...
            <div class="eye-box">
              <i
                @click="showPasswordotpconfirm = !showPasswordotpconfirm"
                :class="[
                  showPasswordotpconfirm ? 'ri-eye-off-line' : 'ri-eye-line',
                ]"
                aria-hidden="true"
              ></i>
            </div>
    ...
    <modal ref="successmodal">
      ...
      <template v-slot:footer>
        <div>
          <button @click="$refs.successmodal.closeModal()" class="loginbtn">
            Login
          </button>
        </div>
      </template>
...
export default {
  ...
  methods: {
    async login() {
      try {
        await Auth.signIn(this.state.email, this.state.password.password).then(
          (data) => {
    ...
    encryptData() {
      this.encData = CryptoJS.AES.encrypt(
    ...
    SubmitForm() {
      ...
      if (
        !this.v$.email.$touch.error &&
        !this.v$.password.password.$touch.error
      ) {
